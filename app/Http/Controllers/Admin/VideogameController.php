    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            [
                ...
                'title.min' => 'almeno 5 caratteri.',
                'title.max' => 'massimo 50 caratteri.',
                'platform.required' => 'la piattaforma è obbligatoria.',
                'platform.min' => 'almeno 5 caratteri.',
                'platform.max' => 'massimo 20 caratteri.',
                'publisher.required' => 'Il publisher è obbligatorio.',
                'publisher.min' => 'almeno 5 caratteri.',
                'publisher.max' => 'massimo 20 caratteri.',
                'genre.required' => 'Il genere è obbligatorio.',
                'genre.min' => 'almeno 5 caratteri.',
                'genre.max' => 'massimo 20 caratteri.',
